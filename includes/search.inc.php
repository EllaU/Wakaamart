<?php
          ...
          class Category{
                ...
                function __construct($searchCat){
                ...
                function getData(){
                        ...
                        if (isset($_GET['pageno'])) {
                            ...
                            $total_pages_sql = "SELECT COUNT(*) FROM product where category='$this->searchCat';";
                        ...
                        $sql="SELECT * FROM product where pname LIKE '%$this->searchCat%' LIMIT $offset, $no_of_records_per_page;";
                        $result = mysqli_query($conn,$sql);
                        ...
                        <li><a href="';echo '?search='.$this->searchCat.'&pageno=1">First</a></li>
                        <li class="'; if($pageno <= 1){ echo 'disabled'; } echo' ">
                            <a href="'; if($pageno <= 1){ echo '#'; } else { echo '?search='.$this->searchCat.'&pageno='.($pageno - 1); } echo' ">Prev</a>
                        </li>
                        <li class="'; if($pageno >= $total_pages){ echo 'disabled'; } echo' ">
                            <a href="'; if($pageno >= $total_pages){ echo '#'; } else { echo '?search='.$this->searchCat.'&pageno='.($pageno + 1); } echo' ">Next</a>
                        </li>
                        <li><a href="';echo '?search='.$this->searchCat.'&pageno='; echo $total_pages; echo ' ">Last</a></li>
                         </ul>
                        ';
                        echo '</div>';
