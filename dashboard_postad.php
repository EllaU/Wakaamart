...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-sm-12 col-md-7 p-5">
                        <h1 class="text-white mt-5 pt-5" style="font-family: 'Prompt', sans-serif;">Post Ad</h1>
                        <p class="mt-2 text-white">Dashboard / <span class="color">Post ad</span></p>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-12 col-sm-10 col-md-12 ">
                                    ...
                                    <ul class="list-unstyled hoverable" style="margin: 0px 0px 0px 0px;">
                                        <li class="px-4 py-4">
                                            ...
                                            <a href="dashboard_postad.php"  style="color: #860270;">Post Ad</a>
                ...
                <div id="adDetails" class="col-lg-5 col-sm-12 col-md-5">
                    ...
                    <div class="card text-white">
                        ...
                        <div class="card-body">
                            ...
                            <form name="postAdForm" class="text-center needs-validation" style="color: #757575;" action='<?php echo "includes/updateAd.inc.php?".$pId?>' enctype="multipart/form-data" method="POST">
                                        <?php
                                          echo $pId;
                                        ?>
                                        <!-- Product Name -->
                              <div class="form-row">
                                  <div class="col">
                                      <!-- First name -->
                                      <div class="md-form ">
                                          <input type="text" id="ProductName" class="form-control validate" name="product_Name" >
                              ...
                              <div class="form-group purple-border mt-3">
                                ...
                                <textarea class="form-control validate" id="Description" rows="3" name="description" ></textarea>
                              </div>
                                        <!-- Features -->
                              <div class="form-group purple-border mt-3">
                                <label class="ml-auto" for="Features">Features</label>
                                <textarea class="form-control" id="Features" rows="3" name="features" ></textarea>
                              </div>
                                        <!-- Price -->
                              <div class="md-form">
                                ...
                                <label for="Price">Price</label>
                                        ...
                                        <!-- Currency -->
                              <select class="browser-default custom-select mb-3" name="currency">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                  ...
                                  <label class="custom-control-label" for="Condition2">Used</label>
                                        ...
                                        <!-- Delivery -->
                              <select class="custom-select browser-default mt-3" name="delivery" >
                                ...
                                <option value="No">No</option>
                                        ...
                                        <!-- Weight -->
                              <div class="md-form">
                                <input type="text" id="Weight" class="form-control validate" name="weight" >
                                <label for="Weight">Weight</label>
                              </div>

                                        <!-- Location -->
                              <div class="md-form">
                                <input type="text" id="Location" class="form-control validate" name="location" >
                              ...
                              <div class="form-row">
                                <div class="col">
                                  <button class="btn  btn-rounded text-white br bg-color my-4 waves-effect z-depth-0" type="submit" onclick="return validateForm()" value="post ad" name="ad_submit">post ad</button>
                                </div>
                                <div class="col">
                                  <button class="btn  btn-rounded text-white br bg-color my-4 waves-effect z-depth-0" type="submit" value="save as draft" name="ad_draft">Save as draft</button>
                                </div>
                              </div>                               
    ...
    <script type="text/javascript">
     ...
     function validateForm(){
       var pname = document.forms['postAdForm']['ProductName'].value;
       var category = document.forms['postAdForm']['Categories'].value;

       var price = document.forms['postAdForm']['Price'].value;
       var image = document.forms['postAdForm']['fileupload'].value;
       var description = document.forms['postAdForm']['Description'].value;
       var location = document.forms['postAdForm']['Location'].value;
