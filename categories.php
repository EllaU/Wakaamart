            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-sm-12 col-md-7 p-5">
                        <h1 class="text-white mt-5 pt-5" style="font-family: 'Prompt', sans-serif;"><?php echo $categoryName;?></h1>
                        <p class="mt-2 text-white">Search results for <span class="color"><?php echo $categoryName;?></span></p>
                    </div>
                </div>
            </div>
